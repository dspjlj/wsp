...
<div id="main">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>添加文本</h3>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<form class="form-horizontal" id="reply_form" style="margin-left: 10px;margin-top:10px;" action="fodderAction!addtext" method="post">	        
			<div class="control-group">
			  <label class="control-label" for="answertype" style="text-align: right;margin-top: -4px;">标题:</label>
			    <div class="controls">
			    <input type="text" name="title" id="ppgjz"/>
				 <div>
