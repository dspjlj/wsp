            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span12">
                                <h3><i class="icon-cog"></i>微官网--文章管理--新增文章</h3>
                            </div>
                        </div>
                        <div class="box-content">
                            <form action="pagearticleAction!add" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">						
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <textarea name="pagearticle.description" id="pagearticle_description" class="input-large" style="height:320px;width:700px;visibility:hidden;"></textarea>
