					...
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<div class="span12">
									<h3>
										<i class="icon-cog"></i>微官网--设置
									</h3>
								</div>
							</div>
							<div class="box-content">
								<form action="wgwAction!add" method="post"
									class="form-horizontal form-validate">
									<s:hidden name="wgw.template1" value="1"></s:hidden>
									<s:hidden name="wgw.template2" value="1"></s:hidden>
