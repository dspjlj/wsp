            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>添加关键字分组</h3>
                            </div>
                        ...
                        <div class="box-content">
                            ...
                            <form id="publickeyform" action="publickeyAction!add" method="post" class="form-horizontal form-validate" novalidate="novalidate">
