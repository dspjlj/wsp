			...
			<div class="container-fluid" style="position: relative;">
				<div>
					<a href="javascript:;" target="_self" id="brand"> <img
							src="media/images/reg/logo2.png" style="margin-top: 6px;" /> </a>
					...
					<div class="dropdown">
						<a href="javascript:;" class='dropdown-toggle' target="_self"
							data-toggle="dropdown" style="width: 127px;"> <nobr>
								...
								<img class="thumb_img" src="" id="pic_apartpic"
		...
		<div class="container-fluid" id="content">
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 素材库 <!--
            ...
            --> </span> </a>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 自定义菜单 </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微官网&nbsp;&nbsp; </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						...
						<li>
							<a href="screenimgAction!view">背景轮播设置</a>
						</li>
...
<!--
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span>微商城</span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微会员&nbsp;&nbsp; </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span>微相册</span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微活动 </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span>微客服</span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span>微团购</span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微预约 </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span>微留言</span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微调研&nbsp;&nbsp; </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微贺卡 </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span>微投票</span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
				...
				<div class="subnav">
					<div class="subnav-title">
						<a href="javascript:void(0);" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span> 微游戏 </span> </a>
					</div>
					<ul class="subnav-menu" style="display: none">
						<li>
							<a href="game_list.html"> 游戏和功能 </a>
						</li>
					</ul>
				</div>
				...
				<div class="subnav bottom">
					<div class="subnav-title">
						<a href="javascript:alert('没有权限');" class='toggle-subnav'> <i
							class="icon-angle-right"></i> <span></span> </a>
					</div>
			...
			<div class="right">
				<div class="main">
					<iframe frameborder="0" id="mainFrame" name="mainFrame"
						src="welcome.jsp"
						style="background: url('media/images/loading.gif') center no-repeat"></iframe>
				</div>
			</div>
