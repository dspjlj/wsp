                ...
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="box-content">
                            <form action="bgmusicAction!update" method="post" class="form-horizontal form-validate">
                            	<s:hidden name="bgmusic.id"></s:hidden>
                              	<s:hidden name="bgmusic.wgw.id"></s:hidden>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
										<textarea name="bgmusic.musicurl" id="weiqi_web_musicmusic" class="input-large" style="height:80px;width:380px;" required="required"><s:property value='bgmusic.musicurl'/></textarea>	
                                        <span class="maroon">*</span>
								 ...
								 <div class="control-group">
                                    ...
                                    <div class="controls">
                                    	<s:if test="bgmusic.ison==0">
                                    		<input type="radio" name="bgmusic.ison" value="0" checked="checked" />关闭&nbsp;&nbsp;<input type="radio" name="bgmusic.ison" value="1"  />开启&nbsp;&nbsp;
                                    	</s:if>
                                    	<s:else>
                                    		<input type="radio" name="bgmusic.ison" value="0" />关闭&nbsp;&nbsp;<input type="radio" name="bgmusic.ison" value="1" checked="checked"/>开启&nbsp;&nbsp;
                                    	</s:else>
                                    </div>
                                </div>
