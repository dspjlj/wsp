            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>修改公众账号</h3>
                            </div>
                        ...
                        <div class="box-content">
                            ...
                            <form id="pubclientform" action="pubclientAction!update" method="post" class="form-horizontal form-validate" novalidate="novalidate" enctype="multipart/form-data">
                                <s:hidden name="pubclient.id"></s:hidden>
                                <s:hidden name="pubclient.imgurl"></s:hidden>
                                <s:hidden name="pubclient.url"></s:hidden>
                                <s:hidden name="pubclient.token"></s:hidden>
                                <s:hidden name="pubclient.encodingaeskey"></s:hidden>
                                <s:hidden name="pubclient.navurl"></s:hidden>
                                <s:hidden name="pubclient.enterurl"></s:hidden>
                                <s:hidden name="pubclient.accessToken"></s:hidden>
                                <s:hidden name="pubclient.createdate"></s:hidden>
                                <s:hidden name="pubclient.deaddate"></s:hidden>
                                <s:hidden name="pubclient.dspuser.id"></s:hidden>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    	...
                                    	<img alt="暂无图片" src="../<s:property value="pubclient.imgurl"/>" id="myimage" width="100" height="100" />
                                    </div>
                                </div>
