            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>修改用户</h3>
                            </div>
                        ...
                        <div class="box-content">
                            ...
                            <form id="dspuserform" action="dspuserAction!update" method="post" class="form-horizontal form-validate" novalidate="novalidate">
								...
								<s:if test="#session.dspuser.limits==0">
	                                ...
	                                <div class="control-group">
	                                    ...
	                                    <div class="controls">
	                                    	<s:textfield name="dspuser.usernum" id="usernum" cssClass="input-medium"></s:textfield>
	                                    	<span class="maroon">*</span><span class="help-inline"></span>
										</div>
	                                </div>
	                                <div class="control-group">
	                                    ...
	                                    <div class="controls">
	                                    	<s:textfield name="dspuser.pubnum" id="pubnum" cssClass="input-medium"></s:textfield>
	                                    	<span class="maroon">*</span><span class="help-inline"></span>
										</div>
	                                </div>
								</s:if>
								...
								<s:hidden name="dspuser.upuser"></s:hidden>
								<s:hidden name="dspuser.password"></s:hidden>
                                <s:hidden name="dspuser.ison"></s:hidden>
                                <s:hidden name="dspuser.regdate"></s:hidden>
                                <s:hidden name="dspuser.id"></s:hidden>
