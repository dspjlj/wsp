			...
			<div class="span5 msg-preview" id="nrdiv1">
				<div class="msg-item-wrapper" relid="">
					<div id="appmsgItem1" class="msg-item">
						<h4 class="msg-t">
							<span class="i-title m-title" rel="title"><s:property value="fodder.title"/></span>
						</h4>
						<p class="msg-meta">
							<span class="msg-date">
						...
						<div class="cover">
							<s:if test="fodder.picurl!=null&&fodder.picurl!=''">
								<img class="i-img m-img" src="../<s:property value="fodder.picurl"/>" id="myimage"
			...
			<div class="span7">
				<div class="msg-editer-wrapper">
					<div class="msg-editer">
						<form id="appmsg-form" class="form" action="fodderAction!updateone" enctype="multipart/form-data" method="post">
							...
							<s:hidden name="fodder.picurl"></s:hidden>
							...
							<div class="control-group">
								...
								<div class="controls">
									<s:textarea name="newsdes" cssStyle="width: 498px; height: 360px;" id="fg" value="%{fodder.description}"></s:textarea>
								</div>
							</div>
