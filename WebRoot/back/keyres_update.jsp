...
<body class="theme-blue" data-theme="theme-blue">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3><i class="icon-edit"></i>修改关键字</h3>
                            </div>
    ...
    function openscset(){
		pophtml('<iframe src="fodderAction!choosefodder?currentpage=keyres_update" style="width:880px;height:470px;border:none;background-color: #dfdfdf;" width="880px" height="475px"></iframe>',920,510,true);
	}
    ...
    function setselid(id){
    	...
    	$('#multiArticle11if').attr('src','/admin/baseService/contresourceshowone-'+id+'.html');
                            ...
                            <form id="keyresform" action="keyresAction!update" method="post" class="form-horizontal form-validate" novalidate="novalidate">
                                <s:hidden name="keyres.id" value="%{#session.keyres.id}"></s:hidden>
                                ...
                                <div class="control-group">
								  <label class="control-label" for="answertype" style="text-align: right;margin-top: -4px;">关键字 :</label>
								    <div class="controls">
								    <s:textfield name="keyres.keytitle" value="%{#session.keyres.keytitle}"></s:textfield>
									 <div>
								...
								<div class="control-group">
								  <label class="control-label" for="answertype" style="text-align: right;margin-top: -4px;">匹配类型 :</label>
								    <div class="controls">
								    <s:select list="#{1:'模糊匹配',2:'全匹配'}" name="keyres.matchtype" value="%{#session.keyres.matchtype}" cssClass="span2"></s:select>
