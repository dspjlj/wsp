...
function savedata(fun){
	...
	var custommenuid = <s:property value="custommenu.id"/>;
	ajax('custommenuAction!mulupdate',{ id:custommenuid,data:$.toJSON(alldata)},function(m){
		alert('保存成功');
		loading(false);
		if(fun){
			fun();
...
function initthedata(){
	...
	<body menuid="3599">
		...
		<s:property value="custommenu.alldata"/>
		</textarea>
