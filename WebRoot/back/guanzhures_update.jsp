...
<body class="theme-blue" data-theme="theme-blue">
    ...
    function openscset(){
		pophtml('<iframe src="fodderAction!choosefodder?currentpage=guanzhures_update" style="width:880px;height:470px;border:none;background-color: #dfdfdf;" width="880px" height="475px"></iframe>',920,510,true);
	}
    ...
    function setselid(id){
    	...
    	$('#multiArticle11if').attr('src','/admin/baseService/contresourceshowone-'+id+'.html');
                            ...
                            <form id="guanzhuresform" action="guanzhuresAction!update" method="post" class="form-horizontal form-validate" novalidate="novalidate">
