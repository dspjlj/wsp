	...
	<body>
		...
		<div class="alert alert-info">
			...
			<p>
				...
				http://#
				<!-- 
				http://www.di3p.com/api/map.html?mtit=魔法屋【所有设置为演示版，请修改】&amp;mcon=人民广场&amp;center=118.343683,35.068229&amp;zoom=15
				 -->
			</p>
		</div>
		<form class="form-horizontal" id="lbsForm" action="lbsAction!update" method="post" enctype="multipart/form-data">
			<s:hidden name="lbs.xylocation" id="xylocation"></s:hidden>
			<s:hidden name="lbs.id"></s:hidden>
			<s:hidden name="lbs.publicaccount"></s:hidden>
			<s:hidden name="lbs.showimg"></s:hidden>
			...
			<div class="control-group">
				...
				<div class="controls">
		               ...
		               <script type="text/javascript">
		                    addressInit('cmbProvince', 'cmbCity', 'cmbArea','<s:property value="lbs.province"/>','<s:property value="lbs.city"/>','<s:property value="lbs.area"/>');  
		               </script> 
				</div>
			</div>
							...
							<tr>
								<td>
									<s:file name="picture" onchange="changePreImg();" id="myfile"></s:file><br/>
                                    	<img alt="暂无图片" src="../<s:property value="lbs.showimg"/>" id="myimage" width="480" height="240" />
								</td>
