...
<body class="yulan" oncontextmenu="return false" onselectstart ="return false" class="theme-blue">
	<s:action name="diypuffAction!frontDiypuff">
		<s:param name="frontpa" value="%{#parameters.frontpa}"></s:param>
	</s:action>
    <div class="main">
        <h1>
        <s:if test="#request.diypuff.title!=null&&#request.diypuff.title!=''">
        	<s:property value="#request.diypuff.title"/>
        </s:if>
        <s:else>
        	暂无信息
        </s:else>
        ...
        <div class="erweima">
            <img id="gzhewm" src="../<s:property value="#request.diypuff.ewmimg"/>"></div>
        <div class="beizhu">
            <div class="beizhubg">
        ...
        <div class="content" id="gzhinfo" style="text-align: center;"><s:property value="#request.diypuff.funinfo"/></div>
        <div class="clr"></div>
        <div class="footer">
            <p id="gzhcopyright"><s:property value="#request.diypuff.copyright"/></p>
        </div>
    </div>
