...
<body>
  ...
  <div class="html" style="background-image: url(pictures/template2_index_15.jpg)">
        ...
        <div class="body">
          ...
          <div class="mod-slider slider-hor" id="index">
            <ul class="slider-list">
              <li>
                <a href="">
                  <img alt="Fooqvkay7orku5fnjtfkjci5l-na" src="pictures/template2_index_1.jpg" />
                </a>
              </li>
              <li>
                <a href="">
                  <img alt="Fvlqrmpwwrh5wipac3xwvm3v7wpn" src="pictures/template2_index_2.jpg" />
                </a>
              </li>
              <li>
                <a href="">
                  <img alt="Fm1bafkhadgddsvdpwdgc21mmu7y" src="pictures/template2_index_3.jpg" />
                </a>
              </li>
              <li>
                <a href="">
                  <img alt="Fsn967fbk156m3a01_wlwk_zawwr" src="pictures/template2_index_4.jpg" />
                </a>
              </li>
              <li>
                <a href="">
                  <img alt="Ftp_gf0mshnfocbifkojsbntg-ir" src="pictures/template2_index_5.jpg" />
                </a>
              </li>
            </ul>
          ...
          <div class="index">
            <a href="2_article.jsp" class="box mod-index"> <i><img alt='麦香村' src='pictures/template2_index_6.jpg' /></i> 
              <small>麦香村</small>
            </a>
            <a href="2_list.jsp" class="box mod-index"> <i><img alt='糕点展' src='pictures/template2_index_7.jpg' /></i> 
              <small>糕点展</small>
            </a>
            <a href="2_list.jsp" class="box mod-index">
              <i>
                <img alt='美食展' src='pictures/template2_index_8.jpg' />
              </i>
              <small>美食展</small>
            </a>
            <a href="tel:15861521065" class="box mod-index">
              <i>
                <img alt='订蛋糕' src='pictures/template2_index_9.jpg' />
              </i>
              <small>订蛋糕</small>
            </a>
            <a href="2_list.jsp" class="box mod-index">
              <i>
                <img alt='会员卡' src='pictures/template2_index_10.jpg' />
              </i>
              <small>会员卡</small>
            </a>
            <a href="2_list.jsp" class="box mod-index">
              <i>
                <img alt='好优惠' src='pictures/template2_index_11.jpg' />
              </i>
              <small>好优惠</small>
            </a>
            <a href="2_list.jsp" class="box mod-index">
              <i>
                <img alt='小知识' src='pictures/template2_index_12.jpg' />
              </i>
              <small>小知识</small>
            </a>
            <a href="2_list.jsp" class="box mod-index">
              <i>
                <img alt='小助手' src='pictures/template2_index_13.jpg' />
              </i>
              <small>小助手</small>
            </a>
            <a href="2_list.jsp" class="box mod-index">
              <i>
                <img alt='小游戏' src='pictures/template2_index_14.jpg' />
              </i>
              <small>小游戏</small>
            </a>
          </div>
