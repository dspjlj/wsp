...
@Component("wtpAction")
@Scope("prototype")
public class WtpAction extends ActionSupport implements RequestAware,
SessionAware,ServletResponseAware,ServletRequestAware {
	 ...
	 * 微投票展示
	 */
	public String frontWtps(){
		wtps = wtpService.getFrontWtpsByPublicAccount(frontpa);
		request.put("wtps", wtps);
		return NONE;
	}
	//=========后台管理=================================================
	/**
	...
	public String list() throws Exception{
		...
		//总记录数
		totalCount=wtpService.getTotalCount(con,convalue,status,publicaccount);
		//总页数
		pageCount=wtpService.getPageCount(totalCount,size);
		if(page>pageCount&&pageCount!=0){
			page=pageCount;
		}
		//所有当前页记录对象
		wtps=wtpService.queryList(con,convalue,status,publicaccount,page,size);
	...
	@Resource
	public void setWtpService(IWtpService wtpService) {
	...
	public void setWtps(List<Wtp> wtps) {
		this.wtps = wtps;
	}
