...
SessionAware,ServletResponseAware,ServletRequestAware {
	...
	public String list() throws Exception{
		...
		//总记录数
		totalCount=wdyService.getTotalCount(con,convalue,status,publicaccount);
		//总页数
		pageCount=wdyService.getPageCount(totalCount,size);
		if(page>pageCount&&pageCount!=0){
			page=pageCount;
		}
		//所有当前页记录对象
		wdys=wdyService.queryList(con,convalue,status,publicaccount,page,size);
