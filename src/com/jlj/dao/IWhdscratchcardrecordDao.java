...
public interface IWhdscratchcardrecordDao {

	//保存一条记录
	public abstract void save(Whdscratchcardrecord whdscratchcardrecord);
	...
	//根据hql语句来查询所有记录
	public abstract List<Whdscratchcardrecord> queryList(String queryString);

	//根据hql、条件值查询某些记录
	public abstract List<Whdscratchcardrecord> getObjectsByCondition(
	...
	//根据hql、id列表查询某些记录
	public abstract List<Whdscratchcardrecord> getObjectsByIdList(
			final String hql, final List<Integer> idList);

	//根据hql语句、条件值、分页查询某些记录
	public abstract List<Whdscratchcardrecord> pageList(
			final String queryString, final Object[] p, final Integer page,
			final Integer size);
	...
	//根据hql语句、条件、值来查询一条记录
	public abstract Whdscratchcardrecord queryByNamedParam(String queryString,
			String[] paramNames, Object[] values);
