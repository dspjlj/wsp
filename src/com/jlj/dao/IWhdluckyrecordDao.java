...
public interface IWhdluckyrecordDao {

	//保存一条记录
	public abstract void save(Whdluckyrecord whdluckyrecord);
	...
	//根据hql语句来查询所有记录
	public abstract List<Whdluckyrecord> queryList(String queryString);

	//根据hql、条件值查询某些记录
	public abstract List<Whdluckyrecord> getObjectsByCondition(
	...
	//根据hql、id列表查询某些记录
	public abstract List<Whdluckyrecord> getObjectsByIdList(final String hql,
			final List<Integer> idList);

	//根据hql语句、条件值、分页查询某些记录
	public abstract List<Whdluckyrecord> pageList(final String queryString,
	...
	//根据hql语句、条件、值来查询一条记录
	public abstract Whdluckyrecord queryByNamedParam(String queryString,
			String[] paramNames, Object[] values);
