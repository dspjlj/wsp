 ...
 */
@Entity
@Table(name = "reqmessage", catalog = "wsp")
public class Reqmessage implements java.io.Serializable {
	...
	public Reqmessage(String tousername, String fromusername,
			String createtime, String msgtype, String msgid, Integer savetype,
			String content, String picurl, String mediaid, String format,
			String thumbmediaid, String locationX, String locationY,
			String scale, String linklabel, String title, String description,
			String url, Date reqtime) {
